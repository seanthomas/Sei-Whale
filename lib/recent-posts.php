...
class Recent_Post_Widget extends WP_Widget {
	...
	function Recent_Post_Widget() {
		$widget_ops = array( 'classname' => 'recent_posts', 'description' => __('TEST A widget that displays recent posts ', 'flatsome') );
		
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'recent_posts' );
		
		parent::__construct( 'recent_posts', __('Recent Posts', 'flatsome'), $widget_ops, $control_ops );
	}
